...
signals = [{'id': 0, 'type': 'file', 'descriptor': 'restaurant_menu_data.txt'},{'id': 1, 'type': 'url', 'descriptor': 'https://en.wikipedia.org/wiki/Web_development'},{'id': 2, 'type': 'function', 'descriptor': 'math.sqrt'},{'id': 3, 'type': 'url', 'descriptor': 'https://www.accuweather.com'},{'id': 4, 'type': 'database', 'descriptor': 'footwear.db'},{'id': 5, 'type': 'function', 'descriptor': 'openai.Completion.create'},{'id': 6, 'type': 'file', 'descriptor': 'anatomy_data.csv'}]
