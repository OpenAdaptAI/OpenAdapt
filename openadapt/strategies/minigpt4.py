...
class MiniGPT4ReplayStrategy(OCRReplayStrategyMixin):
    ...
    def get_next_input_event(
        ...
        # ask question
        user_message = (
            "Please generate the next input event based on the following:\n\n"
            "Task goal: {}\n\n"
            "Previously recorded input events: {}\n\n"
            "Screenshot description: {}\n\n"
            "Please provide your input event below.".format(
                self.recording.task_description, previously_recorded_input_events, text
            )
        )
        ...
        logger.info(f"{self.input_event_idx=} of {num_input_events=}: {input_event=}")
