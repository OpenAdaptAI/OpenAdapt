...
class OpenAIReplayStrategyMixin(BaseReplayStrategy):
    ...
    def get_completion(
        ...
        Args:
            ...
            base64_images (list): The list of base64-encdoed images to include.
            image_detail (str): The detail level for image analysis.
        ...
        # TODO: suppress base64_image from debug output
        logger.debug(f"messages=\n{pformat(messages)}")
        completion = create_openai_completion(self.model_name, messages)
        logger.debug(f"completion=\n{pformat(completion)}")
        # TODO: support images in response
