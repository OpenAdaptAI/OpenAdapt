"""This script executes the Otter model within a modal container and asks the questions
...
class OtterModel:
    ...
    def __enter__(self) -> None:
        """
        Automatically initialize the Otter model and processor upon initializing
        the OtterModel class.
        """
