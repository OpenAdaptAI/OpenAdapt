"""This script executes the InstructBLIP model within a modal container.

The user can interact with the InstructBLIP model by asking the questions
from openadapt/vision/questions.txt about the images in
...
def download_models() -> None:
    """Download the InstructBlip model from Hugging Face's Transformers library."""
...
class InstructBlipModel:
    ...
    def __enter__(self) -> None:
        """Initialize the InstructBlip model and processor.

        Automatically runs upon initializing the InstructBlipModel class.
        """
